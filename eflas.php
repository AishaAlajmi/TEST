  ...
  <div class="head">
    ...
    <div class="container2">
              <div class="form" >
                  ...
                  <i class='bx bx-trending-down' style="color: #cfb99a; font-size: 6.5em; text-align: center;margin-right:33%;"></i><br><br><br><br>
                     
                      <h3 class="titlee">الافلاس</h3><br>
                      <p class="textt">
                          <br> 
                  تقديم الرأي القانوني في اجراءات الافلاس أو الطعن فيها أو التكليف لنقوم نيابة عن الشخص ذو الصفة الطبيعية أو الاعتبارية بمباشرة الاجراء النظامي وفق الموقف المالي سواء في العلاقة مع الدائنين أو المدنيين أو أمين الافلاس أو الجهة ذات العلاقة وفق نصوص نظام الافلاس
                          <br><br><br><br><br>
              ...
              <div class="contact-formm" style="background-color: #1d35391b !important;">
                      <form id="form" name="form" method="POST" action="tagyeem_moha_eflas_validation.php" enctype="multipart/form-data" onsubmit="return validateEflas();">
    ...
    <span style="color: red; margin-left: 5px;">*</span>
     <input type="text" style="background-color: #ffffffc9 !important;" class="input" id="brief" name="brief" placeholder="نبذه عن الموضوع">
            ...
            <div class="input-container textarea" style="display: flex; align-items: center;">
    <span style="color: red; margin-left: 5px;">*</span>
        <input type="text" style="background-color: #ffffffc9 !important;" class="input" id="orders" name="orders"  placeholder="الطلبات" />
         </div> <span class="error-message" id="orders-error"></span>
        
         <div class="input-container textarea" style="display: flex; align-items: center;">
    <span style="color: red; margin-left: 5px;">*</span>
  <input type="text" style="background-color: #ffffffc9 !important;" class="input" id="contact" name="contact" placeholder="وسائل التواصل">
            </div> <span class="error-message" id="contact-error"></span>

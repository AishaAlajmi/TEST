  ...
  <div class="head">
    ...
    <div class="container2">
              <div class="form" >
                  ...
                  <i class='bx bxs-tachometer' style="color: #cfb99a; font-size: 6.5em; text-align: center;margin-right:33%;"></i><br><br><br><br>
                
                      <h3 class="titlee">تقييم عقاري</h3><br>
                      <p class="textt">
                          <br> 
                        تقديم الرأي القانوني في اجراءات التقدير أو الطعن فيها أو التكليف لنقوم نيابة عن العميل بمباشرة أعمال تقدير قيمة العقار أو الضرر اللاحق به أو حالته أو الحق المتعلق به كأجرة المثل واستصدار التقرير من خلال خبير مختص ومرخص
                          <br><br><br><br><br>
              ...
              <div class="contact-formm" style="background-color: #1d35391b !important;">
                      <form id="form" name="form" method="POST" action="tagyeem_moha_eflas_validation.php" enctype="multipart/form-data" onsubmit="return validateTagyeem();">
    ...
    <span style="color: red; margin-left: 5px;">*</span>
        <input type="text" style="background-color: #ffffffc9 !important;" class="input" id="propertyLocation" name="propertyLocation"  placeholder="موقع العقار" />
         </div> <span class="error-message" id="propertyLocation-error"></span>
       
         <div class="input-container textarea" style="display: flex; align-items: center;">
    <span style="color: red; margin-left: 5px;">*</span>
        <input type="text" style="background-color: #ffffffc9 !important;" class="input" id="propertyDescription" name="propertyDescription"  placeholder="وصف العقار" />
         </div> <span class="error-message" id="propertyDescription-error"></span>
        
         <div class="input-container textarea" style="display: flex; align-items: center;">
    <span style="color: red; margin-left: 5px;">*</span>
  <input type="text" style="background-color: #ffffffc9 !important;" class="input" id="propertyPurpose" name="propertyPurpose" placeholder="الغرض من التقرير">
            </div> <span class="error-message" id="propertyPurpose-error"></span>

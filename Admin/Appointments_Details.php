...
<head>
    ...
    <?php include 'appointments_Details_PHP.php'; ?>
    <meta charset="utf-8" />
                ...
                <div class="container">
                    <form action="" method="post" class="row">
                        <div class="col-lg-8 pb-5" style="text-align: right !important ; ">
                            <br>
                            <h1 style="    margin-top: 0;margin-bottom: 0.5rem;font-weight: 500;line-height: 1.2;color: var(--bs-heading-color); color:#1D3539;">تفاصيل الخدمة</h1>
                        </div>
                        <div class="boxs col-md-6">
                            <div class="form-group">
                                <label for="account-fn">الاسم الأول</label>
                                <input class="form-control" style="border-radius: 15px" value="<?php echo $Fristname; ?>" id="first-name" class="form-control" type="text" name="account-fn" disabled="" />
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="form-group">
                                <label for="account-ln">اسم الأب</label>
                                <input class="form-control" style="border-radius: 15px" value="<?php echo $Middlename; ?>" id="middle-name" class="form-control" type="text" name="account-mn" disabled />
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="form-group">
                                <label for="account-ln">الاسم الأخير</label>
                                <input class="form-control" style="border-radius: 15px" value="<?php echo $Lastname; ?>" id="last-name" class="form-control" type="text" name="account-ln" disabled />
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="form-group">
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input class="form-control" style="border-radius: 15px" value="<?php echo $phone; ?>" id="phone" class="form-control" type="text" name="account-phone" disabled />
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="form-group">
                                <label for="account-email">البريد الالكتروني</label>
                                <input class="form-control" style="border-radius: 15px" value="<?php echo $email; ?>" class="form-control" type="email" name="account-email" pattern="[a-z0-9._%+-]+@[a-z0-9.-]+\.[a-z]{2,}$" disabled />
                            </div>
                        </div>
                        <div class="col-md-6">
                            <label for="time">نوع الطلب</label>
                            <div class="form-group">
                                <input class="form-control" style="border-radius: 15px" value="<?php echo $title; ?>" id="last-name" class="form-control" type="text" name="account-ln" disabled />
                            </div>
                        </div>
                        <div class="col-md-6">
                            <label for="time">نوع الدعوى</label>
                            <div class="form-group">
                                <input class="form-control" style="border-radius: 15px" value="<?php echo $filed; ?>" id="last-name" class="form-control" type="text" name="account-ln" disabled />
                            </div>
                        </div>
                        <div class="col-md-6">
                            <label for="time">المدعى</label>
                            <div class="form-group">
                                <input class="form-control" style="border-radius: 15px" value="<?php echo $prosecutor; ?>" id="last-name" class="form-control" type="text" name="account-ln" disabled />
                            </div>
                        </div>
                        <div class="col-md-6">
                            <label for="time">المدعى عليه</label>
                            <div class="form-group">
                                <input class="form-control" style="border-radius: 15px" value="<?php echo $defendant; ?>" id="last-name" class="form-control" type="text" name="account-ln" disabled />
                            </div>
                        </div>
                        <div class="col-md-6">
                            <label for="time">العمل المطلوب</label>
                            <div class="form-group ">
                                <input class="form-control" style="border-radius: 15px" value="<?php echo $required_work; ?>" id="last-name" class="form-control" type="text" name="account-ln" disabled />
                            </div>
                        </div>
                        ...
                        <div class="col-md-6">
                            <label for="time">تفاصيل</label>
                            <div class="form-group textarea-1" oninput="auto_grow(this)"> <?php
                        ...
                        <div class="col-md-6">
                            <label for="time">الطلبات</label>
                             <div class="form-group textarea-1" id="last-name" class="form-control" type="text" name="account-ln" disabled style="border-radius: 15px"><?php echo $requests; ?>
                            </div>
                        </div>
                        <div class="col-md-6">
                            <label for="time">نبذة عن الموضوع</label>
                            <div class="form-group textarea-2" style="border-radius: 15px" id="last-name" class="form-control" type="text" name="account-ln" disabled><?php echo $Brief; ?>
                            </div>
                        </div>
                        <div class="col-md-6">
                            <label for="time">ملاحظات</label>
                            <div class="form-group textarea-2" id="last-name" class="form-control" type="text" name="account-ln" disabled><?php echo $notes; ?>
                            </div>
                        </div>
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <br> <label for="totalPrice">الإجمالي</label>

        ...
        <div class="container">
            ...
            <div class="nav-scroller py-1 mb-3 border-bottom">
                <nav class="nav nav-underline justify-content-evenly">
                    ...
                    <a class="nav-item nav-link link-body-emphasis active" href="Orders_Admin.php">الطلبات الجديدة</a>
                    <a class="nav-item nav-link link-body-emphasis " href="Prev_Orders.php">جميع الطلبات </a>

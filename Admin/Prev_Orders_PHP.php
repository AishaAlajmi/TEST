...
$stmt = mysqli_prepare($conn, 'SELECT * FROM appointments WHERE status != "طلب موعد جديد"');
// Execute the query
...
/**
 * Fetches service title from the database based on the given service ID.
 *
 * @param mysqli $conn The database connection object
 * @param int $service_id The service ID
 * @return string|null The service title or null if not found
 */

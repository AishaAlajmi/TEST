        ...
        <div class="container">
         ...
         <div class="container2">
             <div class="form" >
              ...
              <i class='bx bxs-building-house' style="color: #cfb99a; font-size: 6.5em; text-align: center;margin-right:33%;"></i><br><br><br><br>
           
                <h3 class="titlee">نزاعات الاراضي والعقارات</h3><br>
                <p class="textt">
                    <br>
                    تقديم الاستشارة في نزاعات العقارات والأراضي سواء نزاعات ملكيه أو الاجره أو اعمال المقاولات أو التدخلات أو دمج والازالة ومعالجة إشكالية الصكوك وتعديلها والاضافه والحذف عليها
          <br><br><br><br><br>
          <img width="200px" hight="140px"src="Assets/images/darklogo.png" > 
            ...
            <span style="color:#fff;">لطلب الخدمة الرجاء تعبئة النموذج</span>
              ...
              <div class="contact-formm" style="background-color: #1d35391b !important;">
                    <form id="form" name="form" method="POST" action="Nezaat_validation.php" enctype="multipart/form-data" onsubmit="return validateForm();">
    ...
    <input type="text" style="background-color: #ffffffc9 !important;" class="input" id="department" name="department" placeholder="الدائرة/المكتب/القسم" />
           ...
           <div class="form-inline" id="conditionalField5" style="display: none;">
            ...
            <div class="form-inline" id="conditionalField6" style="display: none;">
                ...
                <option value=""></option>
                    ...
                    <option value="إعداد مذكرة">اعداد مذكرة</option>
                    <option value="تقديم تقرير">تقديم تقرير</option>
                    <option value="تكليف بأعمال المرافعة">تكليف بأعمال المرافعة</option>
                    <option value="أخرى">أخرى</option>
                </select>
            </div>
        ...
        <div class="form-inline" id="conditionalField7" style="display: none;">
                ...
                <option value=""></option>
                    ...
                    <option value="إعداد مذكرة">اعداد مذكرة</option>
                    <option value="تقديم تقرير">تقديم تقرير</option>
                    <option value="تكليف بتولي الأعمال النظامية">تكليف بتولي الأعمال النظامية</option>
                    <option value="أخرى">أخرى</option>
                </select>
            </div>
    ...
    <script>
        ...
        radioOption1.addEventListener("change", function () {
            if (radioOption1.checked) {
                ...
                department.value="";
                lawsuitStatus.value="";
                workRequiredLawsuitValid.value="";

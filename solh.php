        ...
        <div class="container">
         ...
         <div class="container2">
             <div class="form" >
              ...
              <i class='bx bxs-donate-heart' style="color: #cfb99a; font-size: 6.5em; text-align: center;margin-right:33%;"></i><br><br><br><br>

                <h3 class="titlee">الصلح</h3><br>
                <p class="textt">
                    <br>
                    تفويض او توكيل بالتسوية الودية في نزاع قائم          <br><br><br><br><br>

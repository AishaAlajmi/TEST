        ...
        <div class="container">
         ...
         <div class="container2">
             <div class="form" >
              ...
              <i class='bx bx-clipboard' style="color: #cfb99a; font-size: 6.5em; text-align: center;margin-right:33%;"></i><br><br><br><br>
              <h3 class="titlee">المذكرات</h3><br>
                <p class="textt">
                    <br>
                  طلب كتابة اللوائح والمذكرات لقضية منظورة اما الجهات المختصة مثل: لائحة الدعوى, مذكرة جوابية, مذكرة دفاع, مذكرة استئناف, طلب اعادة النظر, طلب النقض          <br><br><br><br><br>
    ...
    <input type="text" style="background-color: #ffffffc9 !important;" class="input" id="department" name="department" placeholder="الدائرة/المكتب/القسم" />
           ...
           <div class="form-inline" id="conditionalField5" style="display: none;">
            ...
            <div class="form-inline" id="conditionalField6" style="display: none;">
                <label for="lawsuitType">نوع المذكرة</label>
                <select id="lawsuitType" name="lawsuitType">
                <option value=""></option>
                    <option value="صحيفة دعوى">صحيفة دعوى</option>
                    <option value="مذكرة جوابية">مذكرة جوابية</option>
                    <option value="مذكرة رد/دفاع">مذكرة رد/دفاع</option>
                    <option value="مذكرة استئناف">مذكرة استئناف</option>
                    <option value="صحيفة التماس اعادة نظر">صحيفة التماس اعادة نظر</option>
                    <option value="مذكرة النقض">مذكرة النقض</option>
                    <option value="أخرى">أخرى</option>
                </select>
            </div>
            <span class="error-message" id="lawsuitType-error"></span>

            <div class="form-inline" id="conditionalField7" style="display: none;">
                <label for="subbmittionDate">تحديد تاريخ استلام المذكرة</label>
                 <input type="date" id="subbmittionDate" name="subbmittionDate" min="<?php echo date('Y-m-d'); ?>">
            </div> <span class="error-message" id="subbmittionDate-error"></span>
        ...
        <div class="input-container" id="conditionalField8"  style="display: none;">  
            <input type="radio" name="radioNotdone" id="lawsuitPaper" value="صحيفة الدعوى"> صحيفة الدعوى
        </div> <span class="error-message" id="lawsuitPaper-error"></span>

  <div class="input-container" id="conditionalField9"  style="display: none;">  
            <input type="radio" name="radioNotdone" id="summons" value="استدعاء">  استدعاء
        </div> <span class="error-message" id="summons-error"></span>
...
<span class="error-message" id="complainant-error"></span>
    ...
    <span style="color: red; margin-left: 5px;">*</span>
        <input type="text" style="background-color: #ffffffc9 !important;" class="input" id="defendant" name="defendant"  placeholder=" المدعي عليه" />
         ...
         <div class="input-container textarea" style="display: flex; align-items: center;">
    <span style="color: red; margin-left: 5px;">*</span>
    <input type="text" style="background-color: #ffffffc9 !important; flex: 1; padding-left: 5px;" class="input" id="brief" name="brief" placeholder="نبذه عن الموضوع">
</div>
<span class="error-message" id="brief-error"></span>
    ...
    <span style="color: red; margin-left: 5px;">*</span>
            ...
            <div id="error-message"></div>
              <div dir="ltr" style="margin-left:30px; margin-right:30px;"> 
                 <button type="submit"  class="buttonn" name="serviceSubmitBtn" href="Alert.html" >إرسال الطلب</button>
              </div>
            </form>
          </div> 
        </div>
    ...
    <script>
      ...
      const involvement = document.getElementById("involvement");
        ...
        const lawsuitPaper = document.getElementById("lawsuitPaper"); 

  ...
  <body dir="rtl">
        ...
        <div class="container">
         ...
         <div class="container2">
             <div class="form" >
              ...
              <i class='bx bxl-internet-explorer' style="color: #cfb99a; font-size: 6.5em; text-align: center;margin-right:33%;"></i><br><br><br><br>
       
                <h3 class="titlee">الجرائم المعلوماتيه / وخدمة التقصي الإلكتروني</h3><br>
                <p class="textt">
                    <br>
                     النيابة في أعمال المرافعة والمدافعة في الإتهام بالجرائم التي تتم باستخدام جهاز الكمبيوتر أو أي جهاز متصل بالشبكة المعلوماتيه.             
                    <br><br><br>
                     النايبة في استصدار بحث وتقصي الكتروني عن طريق الشركات المختصه بهدف نفي التهمه <br><br><br><br><br>
              ...
              <div class="contact-formm" style="background-color: #1d35391b !important;">
                    <form id="form" name="form" method="POST" action="jaraem_Tameen_validation.php" enctype="multipart/form-data" onsubmit="return validateForm();">
   ...
   <div class="input-container" style="display: flex; align-items: center;">
    <span style="color: red; margin-left: 5px;">*</span>
          ...
          </div>  <span class="error-message" id="Whatlawsuitt-error"></span>
    ...
    <input type="text" style="background-color: #ffffffc9 !important;" class="input" id="authorityNumber" name="authorityNumber" placeholder="رقم القضية" />
           ...
           <div class="form-inline" id="conditionalField3" style="display: none;">
            ...
            <div class="input-container " id="conditionalField4" style="display: none;">
    <input type="text" style="background-color: #ffffffc9 !important;" class="input" id="department" name="department" placeholder="الدائرة/المكتب/القسم" />
           ...
           <div class="form-inline" id="conditionalField5" style="display: none;">
            ...
            <div class="form-inline" id="conditionalField6" style="display: none;">
                <label for="workRequiredLawsuitValid">العمل المطلوب</label>
                <select id="workRequiredLawsuitValid" name="workRequiredLawsuitValid">
                <option value=""></option>
                    <option value="مذكرة دفاع">مذكرة دفاع</option>
                    <option value="اصدار تقارير تقصي الكتروني بالنيابة من خلال الخبراء">اصدار تقارير تقصي الكتروني بالنيابة من خلال الخبراء</option>
                    <option value="تكليف بأعمال المرافعة والمدافعة">تكليف بأعمال المرافعة والمدافعة</option>
                </select>
            </div>
            <span class="error-message" id="workRequiredLawsuitValid-error"></span>

            <div class="form-inline" id="conditionalField7" style="display: none;">
                            <label for="submittionDate">تحديد تاريخ استلام المذكرة أو التقرير</label>
                            <input type="date" id="submittionDate" name="submittionDate" min="<?php echo date('Y-m-d'); ?>">
                        </div> 
            <span class="error-message" id="submittionDate-error"></span>
        ...
        <div class="form-inline" id="conditionalField8" style="display: none;">
                <label for="workRequiredLawsuitNotValid">العمل المطلوب</label>
                <select id="workRequiredLawsuitNotValid" name="workRequiredLawsuitNotValid">
                <option value=""></option>
                    <option value="تقديم استشارة">تقديم استشارة</option>
                    <option value="اعداد تقرير قانوني">اعداد تقرير قانوني</option>
                    <option value="اصدار تقارير تقصي الكتروني بالنيابة من خلال الخبراء">اصدار تقارير تقصي الكتروني بالنيابة من خلال الخبراء</option>
                    <option value="التكليف برفع القضية">التكليف برفع القضية</option>
                </select>
            </div>
            <span class="error-message" id="workRequiredLawsuitNotValid-error"></span>   

            <div class="form-inline" id="conditionalField9" style="display: none;">
                            <label for="submittionDateForNotValid">تحديد تاريخ استلام المذكرة أو التقرير أو رفع القضية</label>
                            <input type="date" id="submittionDateForNotValid" name="submittionDateForNotValid" min="<?php echo date('Y-m-d'); ?>">
                        </div> 
            <span class="error-message" id="submittionDateForNotValid-error"></span>
     <!--END OF CHOOSING-->
    ...
    <script>
        ...
        const conditionalField8 = document.getElementById("conditionalField8");
        const conditionalField9 = document.getElementById("conditionalField9");
       const involvement = document.getElementById("involvement");
        ...
        const workRequiredLawsuitValid = document.getElementById("workRequiredLawsuitValid");
        const submittionDate = document.getElementById("submittionDate");
        const workRequiredLawsuitNotValid = document.getElementById("workRequiredLawsuitNotValid");
        const submittionDateForNotValid = document.getElementById("submittionDateForNotValid");
        ...
        radioOption1.addEventListener("change", function () {
            if (radioOption1.checked) {
                ...
                conditionalField8.style.display = "none";
                conditionalField9.style.display = "none";
                 } else {
        ...
        radioOption2.addEventListener("change", function () {
            if (radioOption2.checked) {
                conditionalField8.style.display = "block";
                conditionalField9.style.display = "block";
                conditionalField1.style.display = "none";
                conditionalField2.style.display = "none";
                conditionalField3.style.display = "none";
                conditionalField4.style.display = "none";
                ...
                conditionalField8.style.display = "none";
                conditionalField9.style.display = "none";
                workRequiredLawsuitNotValid.value="";
                submittionDateForNotValid.value="";
            }
        });
    </script>
  </body>

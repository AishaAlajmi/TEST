...
if (isset($_POST['serviceSubmitBtn'])) {
    ...
    elseif($service_id == 8){ //التمثيل
        ...
        $details =details(" صفة طلب التمثيل كوكيل في جانب : ",$details,$representatorType);
        ...
        $details =details( " موقف الدعوى : ",$details,$lawsuitStatus);
            ...
            $details =details( " طلب العميل من الممثل بالنيابة-الوكيل : ",$details,$representator);
    ...
    elseif($service_id == 9){ //المذكرات
        ...
        $details =details(" نوع المذكرة : ",$details,$lawsuitType);

        $subbmittionDate= $_POST["subbmittionDate"];
        $details =details("تاريخ استلام المذكرة : ",$details,$subbmittionDate);
        
        }elseif ($filed==0){
        $radioNotdone= $_POST["radioNotdone"];
        $details =details(" نوع الدعوى الغير مقامة :  ",$details,$radioNotdone);
        }

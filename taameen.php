...
<html>
  ...
  <body dir="rtl">
         ...
         <div class="container2">
             <div class="form" >
              <div class="contact-info" style="background-color: #1D3539;">
               <i class='bx bxs-lock' style="color: #cfb99a; font-size: 6.5em; text-align: center;margin-right:33%;"></i><br><br><br><br>
            
                <h3 class="titlee">التأمين</h3><br>
                <p class="textt">
                    <br>
   ...
   <div class="input-container" style="display: flex; align-items: center;">
    ...
    <input type="text" style="background-color: #ffffffc9 !important;" class="input" id="department" name="department" placeholder="الدائرة" />
           ...
           <div class="form-inline" id="conditionalField5" style="display: none;">
            ...
            <div class="form-inline" id="conditionalField6" style="display: none;">
                ...
                <option value=""></option>
                    ...
                    <option value="اصدار تقارير موقف القضية">اصدار تقارير موقف القضية</option>
        ...
        <div class="form-inline" id="conditionalField8" style="display: none;">
                ...
                <option value=""></option>
                    ...
                    <option value="التكليف برفع القضية ومباشرة الاجراءات النظامية">التكليف برفع القضية ومباشرة الاجراءات النظامية</option>
                </select>
            </div>
